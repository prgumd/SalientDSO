...
{
public:
        inline SampleOutputWrapper(std::string s="points.txt")
        {
        ...
        {
            // Only write point cloud if the frame is marginalized.
            if (!final) {
                return;
            }
            ...
            output_points.open(output_filename_, std::ios_base::app);
